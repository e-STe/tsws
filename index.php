...
<html lang="fr">
	<head>
		...
		<link rel="stylesheet" type="text/css" media="only screen and (min-width:50px) and (max-width:820px)" href="css/mobile.css" />
	...
	<body>
		<div id="body">
			...
			<nav id="menu">
                ...
                <ul>
				    <li> <span><a href="http://tsws.ml">Accueil</a></span> </li>
				    ...
				    <li> <a href="#notnow">Sciences</a> </li>
                <ul>
			</nav>
